...
export default class Scrollbars extends Component {
    ...
    getValues() {
        ...
        const scrollWidth = this.view.scrollWidth - this.getPaddingWidth();
        const scrollHeight = this.view.scrollHeight - this.getPaddingHeight();
        const clientWidth = this.view.clientWidth - this.getPaddingWidth();
        const clientHeight = this.view.clientHeight - this.getPaddingHeight();
